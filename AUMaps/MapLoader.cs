...
namespace AUMaps
{
    public static class MapLoader
    {
        ...
        public static ShipStatus Mira => Maps[1];
        public static ShipStatus Polus => Maps[2];
        public static ShipStatus Airship => Maps[3];

        public static GameObject SkeldObjects => MapObjects[0];
        public static GameObject MiraObjects => MapObjects[1];
        public static GameObject PolusObjects => MapObjects[2];
        public static GameObject AirshipObjects => MapObjects[3];
